...
#define GPIO_NOT_DEFINED \
	-1 /* /< value assumed by reset_gpio when
					 * the reset pin of the IC is not
					 * connected */

#define ADDR_SIZE_HW_REG \
	BITS_32 /* /< value of AddrSize for Hw register
					 * in FTI @see AddrSize */

#define DATA_HEADER \
	4 /* /< size in byte of the header loaded
...
#define DIE_INFO_SIZE \
	16 /* Num bytes of external release
						 * in config */
#define EXTERNAL_RELEASE_INFO_SIZE \
	8 /* Num bytes of release info in
						  * sys info
...
/* RETRY MECHANISM */
#define RETRY_MAX_REQU_DATA \
	2 /* /< Max number of attemps
						 * performed
						  * when requesting data */
#define RETRY_SYSTEM_RESET \
	3 /* /< Max number of attemps
						 * performed
						  * to reset the IC */
